# Databricks notebook source exported at Mon, 11 Jul 2016 10:49:42 UTC
# MAGIC %md
...
xDF = (shakespeareDF
                .select(explode(split(shakespeareDF.word,' ')).alias('word'))
                )

shakeWordsDF = xDF.where(length(xDF.word)!= 0)
shakeWordsDF.show()
